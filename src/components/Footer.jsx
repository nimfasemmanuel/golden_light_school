      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-[40px] mb-[40px]">
        ...
        <div>
          ...
          <p className="font-poppins font-normal text-[16px] leading-[24px] mb-3">
            Nurturing excellence, inspiring futures, and building character
            since 2000.
          </p>
        ...
        <div>
          ...
          <ul className="space-y-2 font-poppins text-[16px] leading-[24px]">
            ...
            <li>
              <a href="/admission" className="hover:text-blue-400">
                Admission
              </a>
            </li>
            <li>
        ...
        <div>
          ...
          <ul className="space-y-2 font-poppins text-[16px] leading-[24px]">
            <li>
              <a href="#student-portal" className="hover:text-blue-400">
                Student Portal
              </a>
            </li>
            <li>
              <a href="#parent-resource" className="hover:text-blue-400">
                Parent Resources
              </a>
            </li>
            <li>
            ...
            <li>
              <a href="#alumni" className="hover:text-blue-400">
                Alumni
              </a>
            </li>
            <li>
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-2 text-[14px]">
          ...
          <p className="font-poppins">
            2025 Golden Light School. All rights reserved.
          </p>
        </div>
